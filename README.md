...
El objetivo de este repositorio es organizar y almacenar el material, ejercicios, prácticas y proyectos desarrollados durante el bootcamp, además de servir como evidencia del proceso de aprendizaje mediante el uso de Git y GitHub.

También permite llevar un seguimiento del progreso en programación desde conceptos básicos hasta la introducción a la programación orientada a objetos.
